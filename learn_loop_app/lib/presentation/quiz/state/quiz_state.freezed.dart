...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( List<Quiz> quizzes,  int currentIndex,  Set<String> selectedOptionIds)?  answering,TResult Function( List<Quiz> quizzes,  int currentIndex,  Set<String> selectedOptionIds,  bool isCorrect,  bool isHiddenChecked)?  showingResult,TResult Function( int correctCount,  int totalCount,  int completedSessions,  bool isAllDone)?  completed,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case QuizLoading() when loading != null:
...
return completed(_that.correctCount,_that.totalCount,_that.completedSessions,_that.isAllDone);case QuizError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( List<Quiz> quizzes,  int currentIndex,  Set<String> selectedOptionIds)  answering,required TResult Function( List<Quiz> quizzes,  int currentIndex,  Set<String> selectedOptionIds,  bool isCorrect,  bool isHiddenChecked)  showingResult,required TResult Function( int correctCount,  int totalCount,  int completedSessions,  bool isAllDone)  completed,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case QuizLoading():
...
return completed(_that.correctCount,_that.totalCount,_that.completedSessions,_that.isAllDone);case QuizError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( List<Quiz> quizzes,  int currentIndex,  Set<String> selectedOptionIds)?  answering,TResult? Function( List<Quiz> quizzes,  int currentIndex,  Set<String> selectedOptionIds,  bool isCorrect,  bool isHiddenChecked)?  showingResult,TResult? Function( int correctCount,  int totalCount,  int completedSessions,  bool isAllDone)?  completed,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case QuizLoading() when loading != null:
return loading();case QuizAnswering() when answering != null:
return answering(_that.quizzes,_that.currentIndex,_that.selectedOptionIds);case QuizShowingResult() when showingResult != null:
...
class QuizCompleted implements QuizState {
  const QuizCompleted({required this.correctCount, required this.totalCount, required this.completedSessions, required this.isAllDone});
...
@override
int get hashCode => Object.hash(runtimeType,correctCount,totalCount,completedSessions,isAllDone);

@override
String toString() {
  return 'QuizState.completed(correctCount: $correctCount, totalCount: $totalCount, completedSessions: $completedSessions, isAllDone: $isAllDone)';
}
...
@useResult
$Res call({
 int correctCount, int totalCount, int completedSessions, bool isAllDone
});
...
/// Create a copy of QuizState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? correctCount = null,Object? totalCount = null,Object? completedSessions = null,Object? isAllDone = null,}) {
