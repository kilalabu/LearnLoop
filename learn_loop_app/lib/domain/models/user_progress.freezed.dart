...
mixin _$UserProgress {
 ...
 String get id; String get quizId; bool get isCorrect; int get attemptCount; DateTime? get lastAnsweredAt; int get forgettingStep; DateTime? get nextReviewAt; bool get isHidden;
...
@override
int get hashCode => Object.hash(runtimeType,id,quizId,isCorrect,attemptCount,lastAnsweredAt,forgettingStep,nextReviewAt,isHidden);

@override
String toString() {
  return 'UserProgress(id: $id, quizId: $quizId, isCorrect: $isCorrect, attemptCount: $attemptCount, lastAnsweredAt: $lastAnsweredAt, forgettingStep: $forgettingStep, nextReviewAt: $nextReviewAt, isHidden: $isHidden)';
}
...
@useResult
$Res call({
 String id, String quizId, bool isCorrect, int attemptCount, DateTime? lastAnsweredAt, int forgettingStep, DateTime? nextReviewAt, bool isHidden
});
...
/// Create a copy of UserProgress
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? quizId = null,Object? isCorrect = null,Object? attemptCount = null,Object? lastAnsweredAt = freezed,Object? forgettingStep = null,Object? nextReviewAt = freezed,Object? isHidden = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String quizId,  bool isCorrect,  int attemptCount,  DateTime? lastAnsweredAt,  int forgettingStep,  DateTime? nextReviewAt,  bool isHidden)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserProgress() when $default != null:
return $default(_that.id,_that.quizId,_that.isCorrect,_that.attemptCount,_that.lastAnsweredAt,_that.forgettingStep,_that.nextReviewAt,_that.isHidden);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String quizId,  bool isCorrect,  int attemptCount,  DateTime? lastAnsweredAt,  int forgettingStep,  DateTime? nextReviewAt,  bool isHidden)  $default,) {final _that = this;
switch (_that) {
case _UserProgress():
return $default(_that.id,_that.quizId,_that.isCorrect,_that.attemptCount,_that.lastAnsweredAt,_that.forgettingStep,_that.nextReviewAt,_that.isHidden);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String quizId,  bool isCorrect,  int attemptCount,  DateTime? lastAnsweredAt,  int forgettingStep,  DateTime? nextReviewAt,  bool isHidden)?  $default,) {final _that = this;
switch (_that) {
case _UserProgress() when $default != null:
return $default(_that.id,_that.quizId,_that.isCorrect,_that.attemptCount,_that.lastAnsweredAt,_that.forgettingStep,_that.nextReviewAt,_that.isHidden);case _:
  return null;
...
class _UserProgress implements UserProgress {
  const _UserProgress({required this.id, required this.quizId, required this.isCorrect, required this.attemptCount, this.lastAnsweredAt, required this.forgettingStep, this.nextReviewAt, this.isHidden = false});
...
/// Create a copy of UserProgress
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? quizId = null,Object? isCorrect = null,Object? attemptCount = null,Object? lastAnsweredAt = freezed,Object? forgettingStep = null,Object? nextReviewAt = freezed,Object? isHidden = null,}) {
